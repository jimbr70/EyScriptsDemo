...
try:
    ...
    mountup += "echo $wuser | sudo -S mount -t cifs -o username=L.CMFCS.01,password=$srusr,domain=et.lab,dir_mode=0777,file_mode=0777 //10.254.34.70/TestShell/ /tmp/csd/RemoteLogs\n"
...
# install python pip, request_ntlm
try:
    ...
    if script_url != 'tbd':
        ...
        try:
            ...
            if script_name.endswith('.sh'):
                ...
                if chmod != 0:
                    raise ValueError('Could not chmod .sh script')
        except:
